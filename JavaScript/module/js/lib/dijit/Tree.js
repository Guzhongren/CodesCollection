define([
	"./_base/array", // array.filter array.forEach array.map
	"./aspect",
	"./cookie", // cookie
	...
	"./dom-class", // domClass.add domClass.remove domClass.replace domClass.toggle
	"./dom-geometry", // domGeometry.setMarginBox domGeometry.position
	"./dom-style", // domStyle.set
	"./errors/create", // createError
	"./fx", // fxUtils.wipeIn fxUtils.wipeOut
	"./has",
	"./_base/kernel", // kernel.deprecated
	"./keys", // arrows etc.
	"./_base/lang", // lang.getObject lang.mixin lang.hitch
	"./on", // on(), on.selector()
	"./topic",
	"./touch",
	"./when",
