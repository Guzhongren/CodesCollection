define([
	...
	".././dnd/move",
	".././_base/fx", // fx.animateProperty
	".././dom-geometry", // domGeometry.position
	".././dom-style", // domStyle.getComputedStyle
	".././keys", // keys.DOWN_ARROW keys.END keys.HOME keys.LEFT_ARROW keys.PAGE_DOWN keys.PAGE_UP keys.RIGHT_ARROW keys.UP_ARROW
	".././_base/lang", // lang.hitch
	".././sniff", // has("ie") has("mozilla")
	".././dnd/Moveable", // Moveable
	".././dnd/Mover", // Mover Mover.prototype.destroy.apply
	".././query", // query
	".././mouse", // mouse.wheel
	".././on",
