define([
	...
	"./dom-attr", // domAttr.set domAttr.get
	"./dom-class", // domClass.add domClass.remove domClass.toggle
	"./dom-construct", // domConstruct.create domConstruct.destroy
	"./dom-style", // domStyle.getComputedStyle domStyle.set domStyle.get
	"./i18n", // i18n.getLocalization
	"./_base/kernel", // kernel.deprecated
	"./keys", // keys.ENTER keys.ESCAPE
	"./_base/lang", // lang.getObject
	"./on",
	"./sniff", // has("ie")
	"./when",
	"./a11yclick",
