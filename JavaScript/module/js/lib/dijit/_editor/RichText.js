define([
	".././_base/array", // array.forEach array.indexOf array.some
	".././_base/config", // config
	".././_base/declare", // declare
	".././_base/Deferred", // Deferred
	".././dom", // dom.byId
	".././dom-attr", // domAttr.set or get
	".././dom-class", // domClass.add domClass.remove
	".././dom-construct", // domConstruct.create domConstruct.destroy domConstruct.place
	".././dom-geometry", // domGeometry.position
	".././dom-style", // domStyle.getComputedStyle domStyle.set
	".././_base/kernel", // kernel.deprecated
	".././keys", // keys.BACKSPACE keys.TAB
	".././_base/lang", // lang.clone lang.hitch lang.isArray lang.isFunction lang.isString lang.trim
	".././on", // on()
	".././query", // query
	".././domReady",
	".././sniff", // has("ie") has("mozilla") has("opera") has("safari") has("webkit")
	".././topic", // topic.publish() (publish)
	".././_base/unload", // unload
	".././_base/url", // url
	".././window", // winUtils.get()
	"../_Widget",
