define([
	".././_base/array", // array.filter array.forEach array.map array.some
	".././_base/Deferred",
	".././aspect", // aspect.after
	".././data/util/sorter", // util.sorter.createSortFunction
	".././_base/declare", // declare
	".././dom", // dom.setSelectable
	".././dom-class", // domClass.toggle
	".././_base/kernel",	// _scopeName
	".././_base/lang", // lang.delegate lang.isArray lang.isObject lang.hitch
	".././query", // query
	".././when",
