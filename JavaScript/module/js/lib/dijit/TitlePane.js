define([
	...
	"./dom-attr", // domAttr.set or get domAttr.remove
	"./dom-class", // domClass.replace
	"./dom-geometry", // domGeometry.setMarginBox domGeometry.getMarginBox
	"./fx", // fxUtils.wipeIn fxUtils.wipeOut
	"./has",
	"./_base/kernel", // kernel.deprecated
	"./keys", // keys.DOWN_ARROW keys.ENTER
	"./_CssStateMixin",
	"./_TemplatedMixin",
	"./layout/ContentPane",
