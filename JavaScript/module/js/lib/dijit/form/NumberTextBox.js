define([
	...
	".././_base/lang", // lang.hitch lang.mixin
	".././i18n", // i18n.normalizeLocale, i18n.getLocalization
	".././string", // string.rep
	".././number", // number._realNumberRegexp number.format number.parse number.regexp
	"./RangeBoundTextBox"
