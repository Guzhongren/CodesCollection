define([
	...
	"./dom", // dom.byId dom.isDescendant
	"./dom-attr", // domAttr.get domAttr.set domAttr.has domAttr.remove
	"./dom-geometry", // domStyle.getComputedStyle domGeometry.position
	"./dom-style", // domStyle.getComputedStyle
	"./keys", // keys.F10
	"./_base/lang", // lang.hitch
	"./on",
	"./sniff", // has("ie"), has("quirks")
