define([
	"require",
	"./_base/array", // array.forEach array.indexOf array.map
	"./aspect",
	"./_base/declare", // declare
	"./Deferred", // Deferred
	"./dom", // dom.isDescendant
	"./dom-class", // domClass.add domClass.contains
	"./dom-geometry", // domGeometry.position
	"./dom-style", // domStyle.set
	"./_base/fx", // fx.fadeIn fx.fadeOut
	"./i18n", // i18n.getLocalization
	"./keys",
	"./_base/lang", // lang.mixin lang.hitch
	"./on",
	"./ready",
	"./sniff", // has("ie") has("opera") has("dijit-legacy-requires")
	"./window", // winUtils.getBox, winUtils.get
	"./dnd/Moveable", // Moveable
	"./dnd/TimedMoveable", // TimedMoveable
	"./focus",
