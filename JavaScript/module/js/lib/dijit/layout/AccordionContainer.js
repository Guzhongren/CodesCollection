define([
	...
	".././_base/fx", // fx.Animation
	".././dom", // dom.setSelectable
	".././dom-attr", // domAttr.attr
	".././dom-class", // domClass.remove
	".././dom-construct", // domConstruct.place
	".././dom-geometry",
	".././keys", // keys
	".././_base/lang", // lang.getObject lang.hitch
	".././sniff", // has("ie") has("dijit-legacy-requires")
	".././topic", // publish
	"../focus", // focus.focus()
